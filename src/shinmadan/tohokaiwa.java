         ...
         if (tohoSINMACanvas.peoplebomkind % 2 == 0) {
            if (var1 == 0) {
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.kaiwa1 = "あー寒いわねー。";
                  tohoSINMACanvas.kaiwa2 = "どうなっているのかしら、";
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.kaiwa1 = "あたいをよんだ？";
                  tohoSINMACanvas.kaiwa2 = "";
                  tohoSINMACanvas.kaiwa3 = "";
                  effectNEXT = 1;
                  effectflag = 1;
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.kaiwa1 = "あ、元凶がきた。";
                  tohoSINMACanvas.kaiwa2 = "";
                  tohoSINMACanvas.kaiwa3 = "";
                  effectflag = 1;
               }
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 0);
                  tohoSINMACanvas.kaiwa1 = "お呼びでないわね。";
                  tohoSINMACanvas.kaiwa2 = "速やかに帰ってくれないかしら？";
                  tohoSINMACanvas.kaiwa3 = "";
                  effectflag = 1;
               }
            } else if (var1 == 5) {
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 1, -1, 0);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 1);
                  tohoSINMACanvas.kaiwa1 = "ひどい！！";
                  tohoSINMACanvas.kaiwa2 = "あんたなんか、さいきょーの";
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 1, -1, 1);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 0);
                  tohoSINMACanvas.kaiwa1 = "私たちは急いでいるの、";
                  tohoSINMACanvas.kaiwa2 = "靈夢、目の前の";
                  tohoSINMACanvas.kaiwa3 = "馬鹿を倒しなさい。";
                  effectflag = 1;
               }
            } else if (var1 == 7 && effectflag == 0) {
               tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 0, -1, 1);
               tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 1, -1, 0);
               tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 0);
               tohoSINMACanvas.kaiwa1 = "わたしは急いでないんだけど…";
               tohoSINMACanvas.kaiwa2 = "";
               tohoSINMACanvas.kaiwa3 = "";
               effectflag = 1;
            }
            ...
            if (var1 == 0) {
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.kaiwa1 = "ああ、寒い。";
                  tohoSINMACanvas.kaiwa2 = "残暑…じゃないな、なんて";
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.kaiwa1 = "余寒（よかん）よ。";
                  tohoSINMACanvas.kaiwa2 = "そんなことより本当に";
               ...
               if (effectflag == 0) {
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 2, -1, 1);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 3, -1, 0);
                  tohoSINMACanvas.kaiwa1 = "素敵な魔法に出会えそうな";
                  tohoSINMACanvas.kaiwa2 = "予感がするぜ。";
                  tohoSINMACanvas.kaiwa3 = "";
                  effectflag = 1;
               }
            } else if (var1 == 4) {
               if (effectflag == 0) {
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 2, -1, 0);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 3, -1, 1);
                  tohoSINMACanvas.kaiwa1 = "嫌な予感しか";
                  tohoSINMACanvas.kaiwa2 = "しないわね。";
                  tohoSINMACanvas.kaiwa3 = "";
                  effectflag = 1;
               }
            } else if (var1 == 5) {
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 3, -1, 0);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 1);
                  tohoSINMACanvas.kaiwa1 = "誰かが遊んでくれそうな";
                  tohoSINMACanvas.kaiwa2 = "予感がしたんだけど？";
                  tohoSINMACanvas.kaiwa3 = "";
                  effectNEXT = 1;
                  effectflag = 1;
               }
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 3, -1, 1);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 0);
                  tohoSINMACanvas.kaiwa1 = "嫌な予感がさっそく";
                  tohoSINMACanvas.kaiwa2 = "あたったわ、寒さの";
               ...
               if (effectflag == 0) {
                  ...
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 3, -1, 0);
                  tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 0);
                  tohoSINMACanvas.kaiwa1 = "いい予感がさっそく";
                  tohoSINMACanvas.kaiwa2 = "あたったぜ、こいつを";
                  tohoSINMACanvas.kaiwa3 = "倒せば寒くなくなるぜ。";
                  effectflag = 1;
               }
            } else if (var1 == 9 && effectflag == 0) {
               tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 2, -1, 0);
               tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 3, -1, 0);
               tohoSINMACanvas.effectIn(1000.0F, 0.0F, 11, 4, 1, 1);
               tohoSINMACanvas.kaiwa1 = "思う存分、よかんを";
               tohoSINMACanvas.kaiwa2 = "楽しんでいけばいいよ！";
               tohoSINMACanvas.kaiwa3 = "";
               effectflag = 1;
            }
         }
